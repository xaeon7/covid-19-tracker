...
const OverviewGlobal = ( {globalData } ) => {
    ...
    return(
            <div className="overview">
                ...
                <div className="total-confirmed"> 
                    <h1><CountUp start = {0} end = {globalData.cases} duration = {1} separator = ','/></h1>
                    <h4>+<CountUp start = {0}  end = {globalData.todayCases} duration = {1} separator = ','/></h4>
                </div>
                <p>Affected countries</p>
                <div className="affected-countries"> 
                    <h2><CountUp start = {0}  end = {globalData.affectedCountries} duration = {1} separator = ','/></h2>
                </div>
            </div>
    );
}
